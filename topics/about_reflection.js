...
const { nok, test } = require('../support/koans')
...
test("hasOwnProperty", () => {
    ...
    deepEqual([keys[0], keys[1]], keys, 'what are the properties of the array?');
    ...
    deepEqual([ownKeys[0]], ownKeys, 'what are the own properties of the array?');
});
